...
@php
    $formatarData = function ($data) {
        ...
        try {
            return \Illuminate\Support\Carbon::parse($data)->format('Y-m-d');
        } catch (\Throwable $e) {
            return $data;
        }
    };
...
<div class="container-fluid py-2 pg-page">
    <div class="pg-content">
        <div class="pg-header">
            <div>
                <h1 class="pg-title">Editar paciente</h1>
                <p class="pg-subtitle">
                    Atualize dados pessoais, contato, endereço e informações complementares do paciente.
                </p>
            </div>
        ...
        <form id="form-paciente" action="{{ route('pacientes.update', $paciente) }}" method="POST">
                ...
                <div class="pg-grid pg-grid-2">
                    ...
                    <div class="pg-field">
                        ...
                        <input type="date"
                               ...
                               class="form-control"
                               value="{{ old('data_nascimento', $formatarData($paciente->data_nascimento)) }}">
                    </div>
                </div>
                ...
                <div class="pg-grid pg-grid-3 mt-3">
                    ...
                    <div class="pg-field">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('telefone', $formatarTelefone($paciente->telefone)) }}"
                ...
                <div class="pg-grid pg-grid-2">
                    <div class="pg-field">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('cpf', $formatarCpf($paciente->cpf)) }}"
                        ...
                        <div class="pg-switch-row">
                            ...
                            <div class="form-check form-switch mt-1">
                                <input class="form-check-input"
                                       ...
                                       id="exige_nota_fiscal"
                                       value="1"
                                       {{ old('exige_nota_fiscal', $paciente->exige_nota_fiscal) ? 'checked' : '' }}>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pg-grid pg-grid-3">
                    <div class="pg-field">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('nome_contato_emergencia', $paciente->nome_contato_emergencia) }}">
                    </div>
                    ...
                    <div class="pg-field">
                        ...
                        <input type="text"
                               ...
                               placeholder="(00) 00000-0000"
                               inputmode="numeric"
                               value="{{ old('telefone_contato_emergencia', $formatarTelefone($paciente->telefone_contato_emergencia)) }}">
                    </div>
                    ...
                    <div class="pg-field">
                        ...
                        <select id="parentesco_contato_emergencia"
                                ...
                                class="form-select">
                            <option value="">Selecione</option>
                            <option value="Pai" {{ old('parentesco_contato_emergencia', $paciente->parentesco_contato_emergencia) === 'Pai' ? 'selected' : '' }}>Pai</option>
                            <option value="Mãe" {{ old('parentesco_contato_emergencia', $paciente->parentesco_contato_emergencia) === 'Mãe' ? 'selected' : '' }}>Mãe</option>
                            <option value="Cônjuge" {{ old('parentesco_contato_emergencia', $paciente->parentesco_contato_emergencia) === 'Cônjuge' ? 'selected' : '' }}>Cônjuge</option>
                            <option value="Filho(a)" {{ old('parentesco_contato_emergencia', $paciente->parentesco_contato_emergencia) === 'Filho(a)' ? 'selected' : '' }}>Filho(a)</option>
                            <option value="Irmão(ã)" {{ old('parentesco_contato_emergencia', $paciente->parentesco_contato_emergencia) === 'Irmão(ã)' ? 'selected' : '' }}>Irmão(ã)</option>
                            <option value="Amigo(a)" {{ old('parentesco_contato_emergencia', $paciente->parentesco_contato_emergencia) === 'Amigo(a)' ? 'selected' : '' }}>Amigo(a)</option>
                            <option value="Outro" {{ old('parentesco_contato_emergencia', $paciente->parentesco_contato_emergencia) === 'Outro' ? 'selected' : '' }}>Outro</option>
                        </select>
                    </div>
                </div>
            </div>
                ...
                <div class="pg-grid pg-grid-4">
                    <div class="pg-field">
                        ...
                        <input type="text"
                               ...
                               value="{{ old('cep', $formatarCep($paciente->cep)) }}"
                               placeholder="00000-000"
                               maxlength="9"
                               inputmode="numeric">
                    </div>

                    <div class="pg-field" style="grid-column: span 1;">
                        <label for="rua">Rua</label>
                        <input type="text"
                               id="rua"
                               name="rua"
                               class="form-control"
                               value="{{ old('rua', $paciente->rua) }}"
                        ...
                        <div class="pg-switch-card py-2">
                            <div class="form-check">
                                <input class="form-check-input"
                                       ...
                                       name="sem_numero"
                                       id="sem_numero"
                                       {{ old('sem_numero', $paciente->numero === 'S/N') ? 'checked' : '' }}>
            ...
            <div class="pg-card">
                ...
                <div class="pg-grid">
                    ...
                    <div class="pg-field">
                        <label for="nova_medicacao">Nova medicação</label>
                        <input type="text"
                               id="nova_medicacao"
                               name="nova_medicacao"
                               class="form-control"
                               placeholder="Ex: Fluoxetina 20mg"
                               value="{{ old('nova_medicacao') }}">

                        <small class="pg-help">
                            Se informado, será registrado no histórico como nova medicação.
                        </small>
                    </div>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (formPaciente) {
        formPaciente.addEventListener('submit', async function(e) {
            ...
            if (form.querySelector('#exige_nota_fiscal') && !form.querySelector('#exige_nota_fiscal').checked) {
