    ...
    <div class="news-form-container">
        ...
        <form action="{{ route('admin.news.update', $news) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                @if ($news->image)
                    <div class="mt-2">
                        <img src="{{ $news->image_url }}" alt="Capa atual" class="rounded shadow" style="max-width: 200px;">
                    </div>
                @endif
            </div>
...
<script>
    function setupCounter(inputId) {
        ...
        const warnAt = Math.floor(max * 0.85);
        ...
        function render() {
            ...
            else if (len >= warnAt) counter.classList.add('near');
        }
