...
<div class="d-none d-lg-block">
    <div class="table-responsive sessoes-table-wrap">
        <table class="table table-hover align-middle mb-0 sessoes-table">
            <thead>
                <tr>
            ...
            <tbody>
                @forelse($sessoes as $sessao)
                    ...
                    <tr>
                        <td>
                            <div class="fw-semibold text-dark paciente-nome">{{ $sessao->paciente->nome }}</div>
                            @if(!empty($sessao->paciente->telefone))
                                <div class="small text-muted paciente-meta">{{ $sessao->paciente->telefone }}</div>
                            @endif
                        </td>
                        ...
                        <td>
                            ...
                            @else
                                ...
                                <div class="small text-muted">{{ \Carbon\Carbon::parse($sessao->data_hora)->format('H:i') }}</div>
                            @endif
                        </td>
...
<style>
    ...
    .sessoes-table tbody tr:last-child td {
        border-bottom: 0;
    }

    .sessoes-table tbody tr:hover {
        background: #fcfdff;
    }
