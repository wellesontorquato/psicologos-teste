...
<style>
    ...
    .sess-content {
        width: 100%;
        max-width: 800px; /* Formulários ficam melhores com largura máxima controlada */
        margin: 0 auto;
    }
...
<div class="container-fluid py-4 sess-page">
    <div class="sess-content">
        ...
        <div class="sess-header">
            <div>
                <h1 class="sess-title">Nova Sessão</h1>
                <p class="sess-subtitle">Agende e registre os detalhes do atendimento.</p>
            </div>
        ...
        <form action="{{ route('sessoes.store') }}" method="POST" class="sess-card">
            @csrf
            ...
            <div class="sess-form-grid">
                ...
                <div class="sess-field sess-col-full">
                    ...
                    <select name="paciente_id" id="paciente_id" class="form-select" required>
                        <option value="" disabled {{ old('paciente_id') ? '' : 'selected' }}>Selecione o paciente...</option>
