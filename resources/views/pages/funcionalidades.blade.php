...
@section('content')
    ...
    <section style="max-width: 1100px; margin: 50px auto; padding: 0 20px;">
                ...
                $features = [
                    ...
                    [
                        ...
                        'details_html' => '
                            ...
                            <p>Acompanhe seu fluxo financeiro com praticidade e mantenha seus registros organizados.</p>
        ...
        {{-- Modal Único --}}
        <div
            class="modal fade modal-soft"
            id="featureModalPage"
            tabindex="-1"
            aria-labelledby="featureModalPageLabel"
            aria-hidden="true"
        >
                ...
                <div class="modal-content modal-soft-content">
                    <div class="modal-header modal-soft-header">
                        <div class="modal-head-left">
                            <h5 class="modal-title" id="featureModalPageLabel">
                                Detalhes
                            </h5>

                            <p class="modal-subtitle">
                                Navegue entre funcionalidades sem sair da página.
                            </p>
                        </div>
                    ...
                    <div class="modal-footer modal-soft-footer">
                        <div class="modal-nav">
                            <button
                                type="button"
                                class="btn btn-outline-light modal-nav-btn"
                                id="featurePrevBtnPage"
                            >
                                ← Anterior
                            </button>
    ...
    <a
        href="https://wa.me/5582991128022?text=Ol%C3%A1%2C%20tenho%20interesse%20no%20PsiGestor%20e%20gostaria%20de%20saber%20mais%20sobre%20os%20planos!"
        target="_blank"
        style="
            position: fixed;
            bottom: 20px;
    ...
    >
        <img
            src="https://psicologos-teste-production.up.railway.app/images/whatsapp.png"
            alt="WhatsApp"
